$(document).ready(function() {
    ...
    // init video14
    //build
    var video14 = new ScrollMagic.Scene({
            triggerElement: ".videos14",
            triggerHook: 0.58
        })
        .setClassToggle(".videos14", 'videos-appear-normalized') //add class
        //.addIndicators({name: "Video"})
        .addTo(controller);

    // init video15
    //build
    var video15 = new ScrollMagic.Scene({
            triggerElement: ".videos15",
            triggerHook: 0.58
        })
        .setClassToggle(".videos15", 'videos-appear-normalized') //add class
        //.addIndicators({name: "Video"})
        .addTo(controller);
    ...
    //build
    var video15 = new ScrollMagic.Scene({
            triggerElement: ".videosFinal",
            triggerHook: 0.58
        })
        .setClassToggle(".videosFinal", 'videos-appear-normalized') //add class
        //.addIndicators({name: "Video"})
        .addTo(controller);
